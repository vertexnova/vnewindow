...
enum class XWinTouchPhase_TP : std::uint8_t { Down, Up, Move };
 ...
 */
struct XWinVneEventCallbacks_C {
    ...
    std::function<void(Window_I*, uint32_t touch_id, double x, double y, XWinTouchPhase_TP phase)> on_touch;
