...
@implementation VneExampleAppDelegate {
...
- (BOOL)application:(UIApplication*)application
    ...
    if (!_runner->initialize()) {
        VNE_LOG_ERROR << "[iOS AppDelegate] ExampleRunner::initialize() failed.";
        return NO;
    }

    // -----------------------------------------------------------------------
    // Bridge: pull the UIView created by UIKitWindow and embed it in a
    // full-screen UIWindow + UIViewController hierarchy.
    // -----------------------------------------------------------------------
...
- (void)applicationDidEnterBackground:(UIApplication*)application {
    // Pause the display link to save power while in background.
